...
public class ServerManagedPolicy implements Policy {
    ...
    public ServerManagedPolicy(Context context, Obfuscator obfuscator) {
        ...
        this.mLastResponse = Policy.LicenseResponse.valueOf(this.mPreferences.getString(PREF_LAST_RESPONSE, Policy.LicenseResponse.RETRY.toString()));
    ...
    public void processServerResponse(Policy.LicenseResponse response, ResponseData rawData) {
        if (response != Policy.LicenseResponse.RETRY) {
            setRetryCount(0L);
        } else {
            setRetryCount(this.mRetryCount + 1);
        }
        if (response == Policy.LicenseResponse.LICENSED) {
    ...
    private void setLastResponse(Policy.LicenseResponse l) {
        this.mLastResponseTime = System.currentTimeMillis();
        this.mLastResponse = l;
        this.mPreferences.putString(PREF_LAST_RESPONSE, l.toString());
    }
    ...
    public boolean allowAccess() {
        ...
        } else if (this.mLastResponse == Policy.LicenseResponse.RETRY && ts < this.mLastResponseTime + MILLIS_PER_MINUTE) {
