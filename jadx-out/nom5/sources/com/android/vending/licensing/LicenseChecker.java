...
public class LicenseChecker implements ServiceConnection {
    ...
    public synchronized void checkAccess(LicenseCheckerCallback callback) {
        if (this.mPolicy.allowAccess()) {
            ...
            if (this.mService == null) {
                ...
                try {
                    boolean bindResult = this.mContext.bindService(new Intent(ILicensingService.class.getName()), this, 1);
                    if (bindResult) {
    ...
    private class ResultListener extends ILicenseResultListener.Stub {
        private Runnable mOnTimeout = new Runnable() { // from class: com.android.vending.licensing.LicenseChecker.ResultListener.1
